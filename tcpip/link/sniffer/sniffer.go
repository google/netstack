...
func (e *endpoint) DeliverNetworkPacket(linkEP stack.LinkEndpoint, protocol tcpip.NetworkProtocolNumber, v buffer.View) {
	logPacket("recv", protocol, v, nil)
	e.dispatcher.DeliverNetworkPacket(e, protocol, v)
}
